...
class PortfolioItemImage(models.Model):
    name = models.CharField(max_length=150)
    image = models.ImageField(upload_to=settings.MEDIA_ROOT + 'portfolio/', null=True, blank=True)
    image_watermark = models.ImageField(upload_to=settings.MEDIA_ROOT + 'portfolio/watermark/', null=True, blank=True)
