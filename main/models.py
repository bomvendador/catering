...
class PortfolioItemImage(models.Model):
    name = models.CharField(max_length=150)
    image = models.ImageField(upload_to='main/static/images//portfolio', null=True, blank=True)
    image_watermark = models.ImageField(upload_to='main/static/images/portfolio/watermark', null=True, blank=True)
